...
class AnalyticsTests(unittest.TestCase):
    ...
    def test_legacy_history_remains_visible_with_default_filters(self):
        ...
        for key,value in {'${client_platform:sqlstring}':"'webgl','windows','unknown'",'${distribution_channel:sqlstring}':"'__all__'",'${release_version:sqlstring}':"'__all__'",'${test_data}':'auto','${playtest_id}':'all'}.items():
