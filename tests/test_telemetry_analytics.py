...
class AnalyticsTests(unittest.TestCase):
    ...
    def test_legacy_history_remains_visible_with_default_filters(self):
        ...
        for key,value in {'${client_platform:sqlstring}':"'webgl','windows','unknown'",'${release_version:sqlstring}':"'__all__'",'${test_data}':'auto'}.items():
            ...
            for board in build().values():
                for panel in board['panels']:
                    for target in panel.get('targets',[]):
                        ...
                        if not sql:continue
                        replacements={'${client_platform:sqlstring}':platform,'${release_version:sqlstring}':"'__all__'",'${test_data}':'auto','${user_id:sqlstring}':"''",'${session_id:sqlstring}':"''",'${llm_request_id:sqlstring}':"''",'${page:sqlstring}':"'0'",'${__from}':'1789257600000','${__to}':'1789862400000'}
