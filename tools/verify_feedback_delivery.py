...
async def main():
    ...
    payload = {"feedback_id": report_id, "description": "验证：截图反馈真实附件与重试去重测试", "contact": "WeChat: feedback_test", "platform": "integration-test", "version": "feedback-v1-validation", "reproduction": "顶着一只猫，14:00–15:00 时在河里钓鱼"}
    ...
    with tempfile.TemporaryDirectory() as folder:
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            assert fields["联系方式"] == payload["contact"]
